...
public class TwitchUtils {
	...
	public static void disableUserLockScreen(Activity a) {
		/** This code causes the screen to turn back off.
	...
	public static boolean twitchServerOnline() {
	    ...
	    try {
	    	// Load a very simple webpage instead of homepage to ensure connectivity
	    	URL url = new URL(TwitchConstants.SERVER_URL + "/twitch_responses/aggregates");
	        ...
	        success = urlConnection.getResponseCode() == 200; // Connection OK?
	    }catch(Exception e){
